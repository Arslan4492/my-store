  ...
  return (
    ...
    >
      <div className="pt-6 mx-auto">
        ...
        {/* Image gallery */}
        <div className="mx-auto my-6 max-w-2xl lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8">
        ...
        {/* Product info */}
        <div className="mx-auto max-w-2xl px-4 pb-8 pt-4 bg-white sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8">
